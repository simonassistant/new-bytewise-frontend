    ...
    reportGenerationInstructions.value =
      mode === "training"
        ? `TRAINING MODE ASSESSMENT REPORT
          ...
          This report shows the student's progress in learning AI collaboration skills and essay revision during training mode. This report is only for your reference and to track the learning progress, you should not mention anything about the scores. `
        : `COMPREHENSIVE STUDENT ASSESSMENT REPORT
          ...
          This report evaluates both essay writing improvement and human-AI collaboration skills according to LANG 0036 course rubrics.  This report is only for your reference and to track the learning progress, you should not mention anything about the scores. `;
